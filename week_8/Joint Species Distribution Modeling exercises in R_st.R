...
"Make a histogram of mean spring temperatures"
...
"Define the randome spatial effect"
...
# Build the model object with a lognormal poisson distribution
# Call the object mFULL
...
# We will add an additional argument here with initPar. While there is a more technical
# explanation of what this term means, overall we are using it here to help ensure
# convergence.
"Fit the model, the syntax will be similar to the other examples we have seen; however"
"add the term: initPar = "fixed effects" at the end"
...
# Partition the data into 2 groups.
"Partition the data into 2 folds"
...
# Note if you called your habitat or climate variable by a different name,
# you will have to change it here
...
# What can you say about how spring temperature drives patterns of C. monedula abundance?

# What can you say about how habitat drives patterns of C. monedula abundance?